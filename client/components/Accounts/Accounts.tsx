        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              This is a list of all connected accounts where you can manage them.
            </p>
          </div>
                ...
                <tr key={account.id}>
                  <td className="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-6">
                    ...
                    <dl className="font-normal lg:hidden">
                      ...
                      <dd className="mt-1 truncate text-gray-700">{account.officialName}</dd>
                      <dt className="sr-only sm:hidden">{account.officialName}</dt>
                      <dd className="mt-1 truncate text-gray-500 sm:hidden">{account.type}</dd>
                    </dl>
                  </td>
                  <td className="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell">{account.officialName}</td>
                  <td className="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">{account.type}</td>
                  <td className="px-3 py-4 text-sm text-gray-500">
                    {account.subtype}
                  </td>
                  <td className="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">

                    <button onClick={() => deleteAccount(account)} className="text-indigo-600 hover:text-indigo-900">
