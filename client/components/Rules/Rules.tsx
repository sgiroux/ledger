        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              This is a list of transaction exclusion rules.  Typically one would like to exclude income, credit card payments, etc. as that
              can skew the ledger results.
            </p>
          </div>
              ...
              {rules.map((rule, index) => (
                <tr key={rule.id}>
                  ...
                  <td className="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                    ...
                    <button onClick={() => editRule(rule)} className="text-indigo-600 hover:text-indigo-900">
