...
import { getSystemStatusSSR, getUserSSR } from "../utils/server-side-render-utils";

function classNames(...classes:string[]) {
  return classes.filter(Boolean).join(' ')
}

const SetupPage = ({}: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Setup</h2>
